...
const zoneCell = "px-5 py-4 text-sm font-semibold text-gray-700 whitespace-nowrap";
const priceCell = "px-5 py-4 text-sm font-bold text-[#0e8f74] whitespace-nowrap";
      ...
      <div className="mx-auto max-w-5xl space-y-12 px-4 py-12 sm:px-6 md:px-8">
        ...
        <section>
          <div className="mb-4 flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-800 sm:text-2xl">Roaming Zone Charges (Text)</h2>
          </div>
          <TableShell>
            <thead>
              <tr className="border-b border-gray-100">
                <th className="px-5 py-4 align-top">
                  <p className="text-sm font-bold text-gray-700">Zones</p>
                  <p className="mt-0.5 text-xs font-normal text-gray-400">Countries</p>
                </th>
                <th className="px-5 py-4 align-top">
                  <p className="text-sm font-bold text-gray-700">Cost Per Text</p>
                  <p className="mt-0.5 text-xs font-normal text-gray-400">Sent from visited Zones to any destinations whilst abroad (£)</p>
                </th>
                <th className="px-5 py-4 align-top">
                  <p className="text-sm font-bold text-gray-700">Cost Per Text</p>
                  <p className="mt-0.5 text-xs font-normal text-gray-400">Received whilst abroad (£)</p>
                </th>
              </tr>
            </thead>
            <tbody>
              {textRows.map((r) => (
                <tr key={r.zone} className="border-b border-gray-100 last:border-0">
        ...
        <section>
          <div className="mb-4 flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-800 sm:text-2xl">Roaming Zones (Calls)</h2>
          </div>
          <TableShell>
            <thead>
              <tr className="border-b border-gray-100">
                <th className="px-5 py-4 align-top">
                  <p className="text-sm font-bold text-gray-700">Countries</p>
                </th>
                <th className="px-5 py-4 align-top">
                  <p className="text-sm font-bold text-gray-700">Roaming Zones (Calls)</p>
                  <p className="mt-0.5 text-xs font-normal text-gray-400">Sent from visited Zones to any destinations whilst abroad (£)</p>
                </th>
                <th className="px-5 py-4 align-top">
                  <p className="text-sm font-bold text-gray-700">Received whilst abroad (£)</p>
                </th>
              </tr>
            </thead>
            <tbody>
        ...
        <section>
          <div className="mb-4 flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-800 sm:text-2xl">Zoiko Roaming Zone Charges (Data)</h2>
          </div>
          <TableShell>
            <thead>
              <tr className="bg-gray-50">
                <th className="px-5 py-4 text-sm font-bold text-gray-700">Zones</th>
                <th className="px-5 py-4 text-sm font-bold text-gray-700">Price (£)/MB</th>
              </tr>
            </thead>
            <tbody>
              {dataRows.map((r) => (
        ...
        <section className="overflow-hidden rounded-2xl border-t-4 border-[#17a06a] bg-white p-6 shadow-sm ring-1 ring-gray-100 sm:p-8">
          <h2 className="text-center text-lg font-bold text-gray-800">For Pay Monthly Subscribers</h2>
          <p className="mt-4 text-sm leading-relaxed text-gray-500">
            For monthly recurring data bundles,{" "}
            <strong className="font-semibold text-gray-700">Zoiko Mobile does not impose a cap</strong>, and any
            Out-of-Bundle usage will be charged at the{" "}
            <strong className="font-semibold text-gray-700">Data Out-of-Bundle Charge rate</strong>. Subscriptions
        ...
        <section className="overflow-hidden rounded-2xl border-t-4 border-[#e6007e] bg-white p-6 shadow-sm ring-1 ring-gray-100 sm:p-8">
          <h2 className="text-center text-lg font-bold text-gray-800">Voice And Text Bundles</h2>
          <div className="mt-4 space-y-4 text-sm leading-relaxed text-gray-500">
            <p>
              Zoiko Mobile offers{" "}
              <strong className="font-semibold text-gray-700">Voice and Text Bundles for National Calls and National Texts</strong>{" "}
